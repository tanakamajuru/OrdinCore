...
export declare class AnalyticsController {
    ...
    multiHouseRiskTrends(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
    ...
    trends(req: Request, res: Response): Promise<Response<any, Record<string, any>>>;
}
