-- Migration: Align RM Governance Flows with Ordin Core Spec

-- 1. Daily Governance Log (Tracking RM Oversight)
CREATE TABLE IF NOT EXISTS daily_governance_log (
    ...
    review_type VARCHAR(20) DEFAULT 'Primary', -- 'Primary' (RM) or 'Deputy Cover'
