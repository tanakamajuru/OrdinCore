...
describe('canonical control position',()=>{
  it('keeps historical failure but allows a later final effective control in the same domain to supersede it for current position',()=>{
    const p=deriveCanonicalControlPosition([
      {id:'a1',status:'Completed',governance_domain:'Environment',effectiveness_outcome:'Not Effective',effectiveness_reviewed_at:'2026-09-01T10:00:00Z'},
      {id:'a2',status:'Completed',governance_domain:'Environment',effectiveness_outcome:'Effective',effectiveness_reviewed_at:'2026-09-10T10:00:00Z'},
    ]);
  ...
  it('blocks an overall effective position when another current domain remains partially effective',()=>{
    const p=deriveCanonicalControlPosition([
      {id:'a1',status:'Completed',governance_domain:'Environment',effectiveness_outcome:'Effective',effectiveness_reviewed_at:'2026-09-10T10:00:00Z'},
      {id:'a2',status:'Completed',governance_domain:'Safeguarding',effectiveness_outcome:'Partially Effective',effectiveness_reviewed_at:'2026-09-11T10:00:00Z'},
    ]);
