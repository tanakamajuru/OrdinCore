...
router.post('/:id/close', requireAuth, requireTenant, requireRole('REGISTERED_MANAGER', 'DIRECTOR', 'ADMIN', 'SUPER_ADMIN'), risksController.closeRisk.bind(risksController));
/**
 * @openapi
