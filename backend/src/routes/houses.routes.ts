...
router.get('/:id/service-users', requireAuth, requireTenant, requireRole('SUPER_ADMIN', 'ADMIN', 'REGISTERED_MANAGER', 'TEAM_LEADER'), housesController.getServiceUsers.bind(housesController));
