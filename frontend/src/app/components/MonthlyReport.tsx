          ...
          <div className="space-y-6">
            <Card className="border-2 border-border">
              ...
              <CardContent className="space-y-4">
                {isLoadingReports ? (
                  <div className="text-center py-4 text-sm text-muted-foreground">Loading reports...</div>
                ) : reports.length === 0 ? (
                  <div className="text-center py-4 text-sm text-muted-foreground">No strategic reports generated yet.</div>
                ) : reports.map((report) => (
