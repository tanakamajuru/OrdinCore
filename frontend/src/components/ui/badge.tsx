...
const badgeVariants = cva(
  "inline-flex items-center rounded-[20px] border px-2.5 py-1 text-[12px]  transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
